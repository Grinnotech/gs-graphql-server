...
(
    ...
    num_code   int4 DEFAULT NULL,
    phone_code int4 NOT NULL
);


INSERT INTO dic_country (iso, name, nice_name, iso3, num_code, phone_code)
...
create index idx_dic_country_name on dic_country(name);
create index idx_dic_country_nice_name on dic_country(nice_name);
